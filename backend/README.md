...
Вместо использования одной AI модели, система объединяет несколько различных моделей:

- **DeepSeek** - Глубокий технический анализ, алгоритмы, архитектура
- **GigaChat** - Креативные задачи, генерация контента, синтез решений
- **YandexGPT** - Глубокий технический анализ, алгоритмы, архитектура
...
2. **Стартовая модель** (по умолчанию DeepSeek) получает запрос от пользователя с контекстом о других доступных моделях
