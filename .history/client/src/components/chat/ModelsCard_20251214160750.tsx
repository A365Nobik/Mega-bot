  ...
  return (
    <>
      {models?.available.length === 0 || !models ? (
        <div className="flex justify-center items-center gap-4 animate-top-appear delay-100">
          <Heading text={{ size: "text-4xl" }}>
            В данный момент доступных моделей нет
          </Heading>
        </div>
      ) : (
                <div className="flex justify-center items-center gap-4 animate-top-appear delay-100"></div>
        <Heading
          text={{
            size: "text-4xl",
          }}
